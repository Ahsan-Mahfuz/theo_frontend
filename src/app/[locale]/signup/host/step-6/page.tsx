...
export default function Step6Page() {
  ...
  const handleContinue = () => {
    router.push('/signup/host/step-7');
  };
  ...
  return (
    <div className="w-full max-w-md flex flex-col items-center animate-in fade-in zoom-in-95 duration-500 text-center">
      <div className="mb-6 flex items-center justify-center">
        <AppImage src="/onboardingbg.png" alt="House" width={180} height={180} />
      </div>

      <h2 className="text-[22px] sm:text-[24px] text-gray-900 font-semibold mb-2">{t('step6.welcome')}</h2>
      <p className="text-[13px] text-gray-500 mb-8 max-w-[380px] inline-block">
        {t('step6.subtitle')}
      </p>
